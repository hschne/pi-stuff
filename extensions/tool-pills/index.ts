 ...
 *
 * • ls, read → colored pill labels + collapsed output
...
export default function (pi: ExtensionAPI) {
  ...
  // Bash is owned by the sandbox extension. Re-registering it here would
  // replace sandbox enforcement, so retain the sandbox's renderer.
