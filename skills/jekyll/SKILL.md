...
This workflow owns only Jekyll's metadata wiring. Establish keyword intent, page content, crawlability, Core Web Vitals, and audit priorities separately; the steps below cover how Jekyll emits correct tags.
