...
Review Rails changes against the conventions below and any stricter project-local instructions. Base findings on complete code paths and observable behavior.
